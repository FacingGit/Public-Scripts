...
adminversion = "M_2 Development by BOREDOMMMMM$0287, Version 2.0"
...
lplayer.Chatted:Connect(function(msg)
	...
	if string.sub(msg, 1, 8) == (prefix.."fecheck") then
		if game:GetService("Workspace").FilteringEnabled == true then
			...
			game:GetService("StarterGui"):SetCore("SendNotification", {
				Title = "FE is Enabled";
				Text = "Filtering Enabled. Enjoy using M_2 Development!";
			})
		else
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "M_2 Development V2 by BOREDOMMMMM$0287";
})
wait(0.1)
print("M_2 Development V2 loaded!")
if game:GetService("Workspace").FilteringEnabled == true then
	warn("FE is Enabled (Filtering Enabled)")
	game:GetService("StarterGui"):SetCore("SendNotification", {
		Title = "FE is Enabled";
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=13355107605"
